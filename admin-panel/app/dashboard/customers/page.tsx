...
export default function CustomersPage() {
  ...
  function customerFormFromRow(row: {
    name: string;
    email?: string | null;
    phone?: string | null;
    contact_number?: string | null;
  ...
  async function openEdit(row: CustomerRow) {
    setEditingId(row.id);
    reset(customerFormFromRow(row));
    clearErrors();
    setDialogOpen(true);
    const res = await apiJson<CustomerDetailResponse>(`/customers/${row.id}`);
    if (res.ok && res.data) {
      reset(customerFormFromRow(res.data));
    }
  }
          ...
          >
            ...
            <div className="flex-1 space-y-4 overflow-y-auto px-4 pb-1">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="cust-telephone">Telephone number</Label>
                  <Controller
                ...
                <div className="grid gap-2">
                  <Label htmlFor="cust-vat">Customer VAT number</Label>
                  <Input
                    id="cust-vat"
